...
## 4.72; [4.7.2.0] - 2025-04-05
- インストール時にエラーが出る問題対応、環境によって縦書きになる問題対応、変体仮名の太さ調整、絵文字修正など
- Fixes issues with errors that occur during installation, fixes issues with vertical writing depending on the environment, adjusts the thickness of variant kana, fixes emoji, etc.
